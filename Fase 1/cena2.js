var cena2 = {
  ...
  create: function () {
      ...
      if (playerCanHitenemy) {
        ...
        if (playerLives <= 0) {
          ...
          this.time.delayedCall(1000, () => {
            ...
            playerCollider = this.physics.add.collider(player, enemyy, hitenemyy, null, this);
          });
        }
      }
    }
    ...
    playerCollider = this.physics.add.collider(this.player, this.enemyy, hitenemyy, null, this);
  ...
  update: function () {
    ...
    var distance = Phaser.Math.Distance.Between(this.player.x, this.player.y, this.enemyy.x, this.enemyy.y);
    if (distance <= 400 && distance >= 200) {
      if (this.enemyy.x > this.player.x) {
        this.enemyy.setVelocityX(-80);
        this.enemyy.anims.play('left1', true);
      } else {
        this.enemyy.setVelocityX(80);
        this.enemyy.anims.play('right1', true);
      }
    }
    else if (distance < 200) {
      if (this.enemyy.x > this.player.x) {
        this.enemyy.setVelocityX(-80);
        this.enemyy.anims.play('left', true);
        ...
        this.enemyy.setVelocityX(80);
        this.enemyy.anims.play('right', true);
      ...
      this.enemyy.anims.play('turn1', true);
    }

    // Movimentação do inimigo 2 em direção ao jogador
    var distance2 = Phaser.Math.Distance.Between(this.player.x, this.player.y, this.enemyy2.x, this.enemyy2.y);
    if (distance2 <= 400 && distance2 >= 200) {
      if (this.enemyy2.x > this.player.x) {
        this.enemyy2.setVelocityX(-80);
        this.enemyy2.anims.play('left1', true);
      } else {
        this.enemyy2.setVelocityX(80);
        this.enemyy2.anims.play('right1', true);
      }
    }
    else if (distance2 < 200) {
      if (this.enemyy2.x > this.player.x) {
        this.enemyy2.setVelocityX(-80);
        this.enemyy2.anims.play('space1-left', true);
        ...
        this.enemyy2.setVelocityX(80);
        this.enemyy2.anims.play('space1-right', true);
      ...
      this.enemyy2.anims.play('turn1', true);
    }

    //movimentação do inimigo 4 em direção ao personagem
    var distance4 = Phaser.Math.Distance.Between(this.player.x, this.player.y, this.enemyy4.x, this.enemyy4.y);
    if (distance4 <= 400 && distance4 >= 200) {
      if (this.enemyy4.x > this.player.x) {
        this.enemyy4.setVelocityX(-80);
        this.enemyy4.anims.play('left1', true);
      } else {
        this.enemyy4.setVelocityX(80);
        this.enemyy4.anims.play('right1', true);
      }
    }
    else if (distance4 < 200) {
      if (this.enemyy4.x > this.player.x) {
        this.enemyy4.setVelocityX(-80);
        this.enemyy4.anims.play('space1-left', true);
        ...
        this.enemyy4.setVelocityX(80);
        this.enemyy4.anims.play('space1-right', true);
      ...
      this.enemyy4.anims.play('turn1', true);
    }

    //movimentação do inimigo 6 em direção ao personagem
    var distance6 = Phaser.Math.Distance.Between(this.player.x, this.player.y, this.enemyy6.x, this.enemyy6.y);
    if (distance6 <= 600 && distance6 >= 200) {
      if (this.enemyy6.x > this.player.x) {
        this.enemyy6.setVelocityX(-80);
        this.enemyy6.anims.play('left1', true);
      } else {
        this.enemyy6.setVelocityX(80);
        this.enemyy6.anims.play('right1', true);
      }
    }
    else if (distance6 < 200) {
      if (this.enemyy6.x > this.player.x) {
        this.enemyy6.setVelocityX(-80);
        this.enemyy6.anims.play('space1-left', true);
        ...
        this.enemyy6.setVelocityX(80);
        this.enemyy6.anims.play('space1-right', true);
      ...
      this.enemyy6.anims.play('turn1', true);
    }
